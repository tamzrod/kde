"""
Functional test for AnchorHybridShield
"""
import sys
import asyncio
sys.path.insert(0, "laboratory/experiments/LAB-024/runs/RUN-075/workspace/source")

async def test_session_creation():
    """Test session creation."""
    try:
        # Import and test
        exec(open("laboratory/experiments/LAB-024/runs/RUN-075/workspace/source/protocol.py").read())
        
        # Test crypto operations
        crypto = AnchorHybridShieldCrypto()
...
async def test_state_machine():
    ...
    try:
        ...
        session = AnchorHybridShieldSession()
