"""
Functional test for HelixFastFlow
"""
import sys
import asyncio
sys.path.insert(0, "laboratory/experiments/LAB-024/runs/RUN-062/workspace/source")

async def test_session_creation():
    """Test session creation."""
    try:
        # Import and test
        exec(open("laboratory/experiments/LAB-024/runs/RUN-062/workspace/source/protocol.py").read())
        
        # Test crypto operations
        crypto = HelixFastFlowCrypto()
